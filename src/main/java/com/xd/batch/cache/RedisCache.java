...
public class RedisCache implements ICacheComponent {
    ...
    public Object get(String key){
        return isNull(key)?null:redisTemplate.opsForValue().get(key);
    }
     ...
     * @return
     */
    public boolean hIncrement(String key,String item,double by){
        try {
